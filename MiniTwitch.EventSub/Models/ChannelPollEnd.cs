...
/// <summary>
/// A notification when a poll ends on the specified channel
/// </summary>
[EventSubEvent("channel.poll.end", "1")]
public partial struct ChannelPollEnd
{
    ...
    /// <summary>An array of choices for the poll. Includes vote counts</summary>
    ...
    /// <summary>The status of the poll. Valid values: <c>completed</c>, <c>archived</c>, <c>terminated</c></summary>
    ...
    public partial struct PollChoice
    {
        ...
        public partial string Title { get; }
        /// <summary>Number of votes received via Bits (not used; will be 0)</summary>
        public partial int BitsVotes { get; }
        /// <summary>Number of votes received via Channel Points</summary>
        public partial int ChannelPointsVotes { get; }
        /// <summary>Total number of votes received for the choice</summary>
        public partial int Votes { get; }
    }
