...
/// <summary>
/// A notification when the broadcaster stops a charity campaign
/// </summary>
[EventSubEvent("channel.charity_campaign.stop", "1")]
public partial struct ChannelCharityCampaignStop
{
    /// <summary>An ID that identifies the charity campaign</summary>
    public partial string Id { get; }
    /// <summary>An ID that identifies the broadcaster that ran the campaign</summary>
    ...
    public partial DateTimeOffset StoppedAt { get; }
